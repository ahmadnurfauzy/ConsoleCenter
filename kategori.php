...
<html>
<head>
<title>Console Center - Console</title>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="daftarorder.php">My Transaction</a></li>
								</ul>
							</div>
							</nav>
			</div>
									...
									<figure>
										<div class="snipcart-item block">
											...
											<div class="snipcart-details top_brand_home_details">
												<fieldset>
													<a href="product.php?idproduk=<?php echo $p['idproduk'] ?>"><input type="submit" class="button" value="Detail" /></a>
												</fieldset>
											</div>
										</div>
									</figure>

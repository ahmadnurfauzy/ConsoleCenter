...
<html>
<head>
<title>Console Center - Produk</title>
...
<body>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="konfirmasi.php">My Transaction</a></li>
								</ul>
							</div>
							</nav>
			</div>
	...
	<?php $p = mysqli_fetch_array(mysqli_query($conn,"Select * from produk where idproduk='$idproduk'"));?>
